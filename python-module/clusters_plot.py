...
output_filename = f'plot_jp_{d_dimensions}D{k_clusters}K{n_samples}N.png'
if os.path.exists(output_filename):
    os.remove(output_filename)  # Remove the existing file

pyplot.title(f'[IRIS dataset][{n_samples} samples][clusters Graph]')
plot_filename = f"plot_clusters_{d_dimensions}D{k_clusters}K{n_samples}N.png"
